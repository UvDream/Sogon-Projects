...
<template>
  <div class="dashboard-bottom" style="height:auto">
    <div class="dashboard-bottom-left">
      <Title title="九类八类入所人员数与涉黑打处数对比" v-model="data"/>
      <div class="dashboard-bottom-left-table">
        ...
        <div class="dashboard-bottom-left-table-right">
          <div>
            <section>九类八类入所人员数</section>
            <section>涉黑打处数</section>
          </div>
          <div v-for="(item, index) in tableList" :key="index">
            <section>
              <a-input v-model="item.jlblajrsnum" :disabled="disabled"/>
            </section>
            <section>
              <a-input v-model="item.shdcsnum" :disabled="disabled"/>
            </section>
          </div>
        </div>
      </div>
    ...
    <div class="dashboard-bottom-right">
      ...
      <div class="dashboard-bottom-right-content">
        <img style="width: 80%" src="../../assets/images/a_ypfx8.png" />
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    saveFunc() {
      let param = {
        ...
        lastThirtyNineEightBeEntryAndMafiaList: this.tableList,
      };
