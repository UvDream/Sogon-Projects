...
<template>
  <div class="dashboard">
    ...
    <div class="dashboard-file white-block">
      ...
      <div class="dashboard-file-content">
        <div class="dashboard-file-content-table">
          <div class="dashboard-file-content-table-title">最新发现10名病患档案</div>
          <div
            class="list"
    ...
    <div class="dashboard-file white-block" style="margin-top:20px">
      ...
      <div class="dashboard-file-content">
        <div class="dashboard-file-content-table">
          <div class="dashboard-file-content-table-title">各阶段病患档案占比</div>
    ...
    <div class="dashboard-file white-block" style="margin-top:20px">
      ...
      <div class="dashboard-file-content">
        <div class="dashboard-file-content-table">
          <div class="dashboard-file-content-table-title">补助金发放记录</div>
          <div
            class="list"
            v-for="(item,index) in tableList"
            :key="index"
